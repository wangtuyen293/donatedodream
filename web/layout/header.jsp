    ...
    <div class="preloader d-flex align-items-center justify-content-center">
        <div class="preloader-inner position-relative">
            ...
            <div class="preloader-img pere-text">
                <img src="${request.contextPath}/project_donator_3/assets/img/logo/dendi2.png" alt>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="container-fluid">
                <div class="menu-wrapper row">
                    <div class="col-2 logo d-flex justify-content-center align-items-center mb-0">
                        <a href="${request.contextPath}/project_donator_3/home">
                    ...
                    <div class="col-6 main-menu d-none d-lg-block">
                        <nav>
                            <ul id="navigation" class="mb-0">
                                ...
                                <li><a class="text-decoration-none" href="allproject.jsp">Projects</a></li>
